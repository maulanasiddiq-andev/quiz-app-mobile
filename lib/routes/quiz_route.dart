...
final List<GoRoute> quizRoutes = [
  GoRoute(
    path: "/${ResourceConstant.quiz}/${ActionConstant.detail}/:id",
  ...
  // update quiz
  GoRoute(
    path: '/${ResourceConstant.quiz}/${ActionConstant.edit}/:id',
    builder: (context, state) {
      final quizId = state.pathParameters['id'];
  ...
  // create quiz pages
  GoRoute(
    path: "/${ResourceConstant.quiz}/${ActionConstant.create}",
  ...
  // get quizzes by user
  GoRoute(
    path: "/${ResourceConstant.quiz}/${ResourceConstant.user}/:id",
    builder: (context, state) {
